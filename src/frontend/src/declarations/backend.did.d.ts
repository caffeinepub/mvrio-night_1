...
export interface _SERVICE {
  ...
  'addSong' : ActorMethod<
    ...
    bigint
  >,
  'addToOfficialPlaylist' : ActorMethod<[string, bigint], undefined>,
  ...
  'createOfficialPlaylist' : ActorMethod<[string], undefined>,
  ...
  'isAdminArtist' : ActorMethod<[], boolean>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'playSong' : ActorMethod<[bigint], undefined>,
  'removeFromOfficialPlaylist' : ActorMethod<[string, bigint], undefined>,
